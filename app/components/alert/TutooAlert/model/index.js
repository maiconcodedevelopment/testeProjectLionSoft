...
class TutooAlert extends React.Component{
    ...
    render(){
        ...
        const { onPress , title , message , buttons , icon } = this.props
...
const styles = StyleSheet.create({
    ...
    boxIcon : {
         position : "absolute" , alignItems : "center" , justifyContent : "center" , backgroundColor : "red" , width : HEIGHT_CARD_ICON , height : HEIGHT_CARD_ICON , top : -HEIGHT_CARD_ICON / 2 , borderRadius : 50
    },
    boxText : {
        flex : 1,
        alignItems : "center",
